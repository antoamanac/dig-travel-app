...
app.get("/", (req: Request, res: Response, next: NextFunction) => {
  ...
  if (userAgent.includes("GoogleHC") || userAgent.includes("kube-probe") || req.query._health !== undefined) {
...
const defaultPort = isDev ? "5000" : "8081";
...
async function startServer() {
  try {
    ...
    log("Failed to register routes:", err);
    process.exit(1);
  }
